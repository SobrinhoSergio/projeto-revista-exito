...
if (isset($_GET['page'])) {
    ...
    $queryPaginated = $tema->getPaginator($maxRows, $offset);
}

loadView('noticia_tema_list', ['pages' => $pages, 'queryPaginated' => $queryPaginated, $_GET]);
