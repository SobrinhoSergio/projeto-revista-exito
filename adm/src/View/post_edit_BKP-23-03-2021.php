        ...
        <form action="#" method="post" enctype="multipart/form-data" id="form-edition-post">
            <div class="form-container">
                ...
                <div class="form-field">
                    ...
                    <?php while($anuncio = $sponsors->fetch_assoc()): ?>
                        <?php if (explode('=', $anuncio['link_anuncio'])[1] == $_GET['post_id']): ?>  
                    ...
                    <?php if ($slide != 1 && new DateTime($validade_materia) >= new DateTime("now")): ?>
                        <a class="slideshow-anchor add-slideshow" href="add_slideshow.php?post_id=<?=$chave_materia?>&description=<?=filter_var($titulo_materia, FILTER_SANITIZE_STRING)?><?php if ($tipo_materia == 2) { echo "&expiration=". date("Y-m-d", strtotime($validade_materia)); } ?>">
                ...
                <div class="form-field" id="main-img-field" style="position: relative;">
                    ...
                    <img class="img-preview" id="img-preview-main" src="<?=dirname("../materia.php")?>/img/posts/thumbs/<?=$chave_materia?>.png" alt="imagem">
