...
<div class="users-list-table">
    ...
    <table>
        ...
        <!-- valores da tabela -->
        <?php $var = rand(1, 100);
        while ($result = $queryPaginated->fetch_assoc()) : ?>
            <tr>
                <td>
                    <div class="td-div img-post-list-div">
                        <img class="img-post-list" src="<?= dirname("../materia.php") ?>/img/posts/thumbs/<?php echo $result['chave_materia']; ?>.png?var=<?php echo $var ?>" alt="Miniatura da matéria">
                    </div>
                </td>
                ...
                <td>
                    <div class="td-div">
                        <?php if (($_SESSION['type_user'] != 1 && $result['tipo_materia'] >= 4) || ($_SESSION['type_user'] == 1)) : ?>
                            <a href="post_edit_controller.php?post_id=<?php echo $result['chave_materia']; ?>&page=<?php echo $_GET['page'] ?>">Editar</a>
                        <?php endif ?>
                        <div>
...
<div class="list-pages">
    ...
    for ($i = 1; $i <= $pages; $i++) {
        echo "<option value='posts_list_controller.php?page=$i'>$i</option>";
    }
    echo "</select>";
