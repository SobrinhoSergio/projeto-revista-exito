...
//Repostagem dos últimos posts 

//$list = $post->getPostsByDate(['tipo_materia' => 3]);



/*$listFull = $post->getResultFromSelect(['ativo' => 1, 'publicar' => 1] + $filtros);
$list =  $post->getPaginator(4, '', '*', 'DESC', 1, $filtros);
...
if (isset($_GET['page'])) {
    ...
    $list = $post->getPaginator(4, $offset, '*', 'DESC', 1, $filtros);
}*/
